        ...
        <div class="card-body">
            <form class="form-horizontal" method="POST" action="" name="myForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="radio" name="aktif" id="inputAktifY" value="Y">
                    <label for="inputAktifY">Aktif</label><br>
                    <input type="radio" name="aktif" id="inputAktifT" value="T">
                    <label for="inputAktifT">Tidak Aktif</label>
                </div>
